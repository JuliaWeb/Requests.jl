...
files = [
  FileParam(readall(filename),"application/octet-stream","file1","runtests.jl"),
  FileParam(open(filename,"r"),"application/octet-stream","file2","runtests.jl",true),
  FileParam(Base.File(filename),"application/octet-stream","file3","runtests.jl"),
  FileParam(IOBuffer(readall(filename)),"application/octet-stream","file4","runtests.jl")
  ]
